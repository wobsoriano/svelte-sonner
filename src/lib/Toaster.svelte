...
<style global>
  ...
  [data-sonner-toast] {
    ...
    -webkit-transition: transform 400ms, opacity 400ms, height 400ms, box-shadow 200ms;
    -moz-transition: transform 400ms, opacity 400ms, height 400ms, box-shadow 200ms;
  ...
  [data-sonner-toaster][data-theme='light'] {
    ...
    --info-bg: hsl(210, 85%, 96%);
    --info-border: hsl(210, 92%, 91%);
    --info-text: hsl(210, 100%, 27%);

    --warning-bg: hsl(60, 85%, 96%);
    --warning-border: hsl(60, 92%, 91%);
    --warning-text: hsl(60, 100%, 19%);
  }
  ...
  [data-sonner-toaster][data-theme='dark'] {
    ...
    --info-bg: hsl(210, 100%, 6%);
    --info-border: hsl(207, 100%, 12%);
    --info-text: hsl(210, 86%, 65%);

    --warning-bg: hsl(60, 100%, 6%);
    --warning-border: hsl(57, 100%, 12%);
    --warning-text: hsl(60, 86%, 65%);
  }
